...
<div class="list-filters">
  ...
  <a href="/escuelaverano2021/program/" class="list-filter">Program</a>
...
<body>
  <div class="container">
		...
		<section id="main-bio">
			...
			<h2>Dr. Pascale Fung</h2>
      <h4>Professor at The Hong Kong University of Science & Technology</h4>
      <br>
			<!-- Headshot image -->
			<img width="225" id="bio-image" src="{{ 'assets/images/Pascale.jpg'| relative_url }}"  align="left" alt="Pascale Fung" hspace="10">
      ...
      <h3>Talk title: "Conversational AI" </h3>
...
<body>
  <div class="container">
      ...
      <h3>Contact information</h3>
			<ul>
				<li><strong>LinkedIn:</strong> <a href="https://www.linkedin.com/in/sujithravi/">Dr. Ravi's LinkedIn</a></li>
				<li><strong>Web:</strong> <a href="https://www.sravi.org/">Personal page.</a></li>
        <li><strong>Twitter:</strong> <a href="https://twitter.com/ravisujith">@ravisujith</a></li>
			</ul>
		</section>
	</div>
</body>
...
<body>
  <div class="container">
      ...
      <br>
			<!-- Headshot image -->
			<img width="215" id="bio-image" src="{{ 'assets/images/Heng.jpg'| relative_url }}"  align="left" alt="Heng Ji" hspace="10">
...
<body>
  <div class="container">
		...
		<section id="main-bio">
			<!-- h2: Tier-2 Headline (Not as important as the h1 header, but more than one allowed). -->
			<h2>Dr. Sebastian Ruder</h2>
      <h4>Researcher at DeepMind</h4>
      <br>
			<!-- Headshot image -->
			<img width="220" id="bio-image" src="{{ 'assets/images/SebastianRuder.jpg'| relative_url }}"  align="left" alt="Sebastian Ruder" hspace="10">
      Sebastian Ruder is a research scientist in the Language team at DeepMind, London. He completed his PhD in Natural Language Processing and Deep Learning at the Insight Research Centre for Data Analytics, while working as a research scientist at Dublin-based text analytics startup AYLIEN. Previously, he studied Computational Linguistics at the University of Heidelberg, Germany and at Trinity College, Dublin. He is interested in transfer learning for NLP and making ML and NLP more accessible.
		...
		<!-- Section 2: Additional Information -->
		<section id="additional-info">
      <h3>Talk title: "Challenges in Cross-lingual Transfer Learning"</h3>
      ...
      <h3>Contact information</h3>
			<ul>
				<li><strong>Web:</strong> <a href=" https://ruder.io/">Personal page.</a></li>
        <li><strong>Twitter:</strong> <a href=" https://twitter.com/seb_ruder">@seb_ruder</a></li>
			</ul>
		</section>
	</div>
</body>
...
<body>
  <div class="container">
    ...
    <br>
      ...
      GRIGORI SIDOROV obtained his PhD in Philology (Computational and Structural Linguistics) from “Lomonosov” Moscow State University, Russia, in 1996. He is currently full professor of Natural Language Processing Laboratory, Center for Computing Research, National Polytechnic Institute in Mexico City, Mexico. Dr. Sidorov is National Researcher of Mexico level 3 (highest level, about 3-4% of all researchers in Mexico have this level), member of Mexican Academy of Sciences, Editor-in-Chief of the research journal “Computación y Sistemas” (ISI Master Journal List, Scopus, CONACYT, etc.), author of more than 270 scientific publications, of which 9 books). His research interests include computational linguistics, natural language processing and application of machine learning techniques to NLP tasks.
    <br>
		<!-- Section 2: Additional Information -->
		<section id="additional-info">

			<h3>Tutorial: Natural Language Processing, Introduction </h3>
  ...
  <div class="container">
      ...
      <br>
		...
		<section id="additional-info">
			...
			<h3>Tutorial: “Redes Neuronales: conceptos básicos y aplicaciones”</h3>
